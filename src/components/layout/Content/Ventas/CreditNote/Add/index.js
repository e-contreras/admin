                        ...
                        <div className="col-md-12">
                                    ...
                                    <div className="box-body">
                                        ...
                                        <div>
                                            <div className="row">
                                                ...
                                                <div className="col-md-4">
                                                    <div className="form-group">
                                                        <label htmlFor="ruc">Fecha de emisión</label>
                            ...
                            <div className="box">
                                <div className="box-header">
                                    <h3 className="box-title">Concepto</h3>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr>
                                                            <td colSpan="5" style={{textAlign: 'right'}}>
                                                                <button className="btn btn-primary"><i className="fa fa-hourglass"></i> Generar</button> 
                                                                &nbsp;
                                                                <button className="btn btn-primary"><i className="fa fa-print"></i> Imprimir</button>
                                                            </td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
